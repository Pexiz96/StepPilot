...
{
    /// <inheritdoc />
    public partial class StepPilotWorkforceCore : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ScheduleChanges_Schedules_ScheduleId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Shifts_Qualifications_RequiredQualificationId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AvailableUntil = table.Column<TimeOnly>(type: "time", nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ScheduleChanges_ScheduleId",
                table: "ScheduleChanges",
                column: "ScheduleId");

            migrationBuilder.CreateIndex(
                name: "IX_ShiftAssignments_CompanyId_ShiftId_EmployeeId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Shifts_RequiredQualificationId",
                table: "Shifts",
